...
vk.updates.on('message_new', async (context: any, next: any) => {
	...
	if (!user_check) {
		...
		const data_answer: any = {
			...
			Подайте заявку в гостиную: https://vk.com/club203252392
			...
			Подайте заявку в гостиную: https://vk.com/club200655488
			...
			Подайте заявку в гостиную: https://vk.com/slytherin_hogonline
			...
			Подайте заявку в гостиную: https://vk.com/griffindor_hogonline
